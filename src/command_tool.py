...
from hackernews_client import HackerNewsClient #从hackernews_client模块导入HackerNewsClient类，用于HackerNews信息收集
...
def main():
    ...
    command_handler = CommandHandler(github_client, hacker_news_client, subscription_manager, report_generator)  # 创建命令处理器实例
